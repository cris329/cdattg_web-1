...
route::middleware('can:VER FICHA CARACTERIZACION')->group(function () {
    ...
    Route::get('/fichaCaracterizacion/create', [FichaCaracterizacionController::class, 'create'])->name('fichaCaracterizacion.legacy.create');
    Route::post('/fichaCaracterizacion/store', [FichaCaracterizacionController::class, 'store'])->name('fichaCaracterizacion.legacy.store');
    ...
    Route::post('/fichaCaracterizacion/{id}/desasignar-aprendices', [FichaCaracterizacionController::class, 'desasignarAprendices'])->name('fichaCaracterizacion.legacy.desasignarAprendices');
});
