                                ...
                                <div class="card" style="background-color: #ffffff; border-color: #dee2e6;">
                                    ...
                                    <div class="card-body">
                                        <div class="alert alert-info">
                                            ...
                                            Por favor suba una copia digital de su documento de
                                            identidad
                                            en formato PDF.
                                        ...
                                        <form id="formDocumentos" method="POST"
                                            ...
                                            <div class="form-check mb-4">
                                                <input class="form-check-input" type="checkbox" id="acepto_privacidad"
                                                    required>
                                            ...
                                            <input type="hidden" name="acepto_privacidad" id="acepto_privacidad_hidden"
                                                value="0">
